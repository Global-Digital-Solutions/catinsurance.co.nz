    ...
    <>
      ...
      <section className="bg-gradient-to-br from-emerald-600 to-teal-700 text-white py-14">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl sm:text-4xl font-bold mb-3">Compare Cat Insurance NZ</h1>
          <p className="text-emerald-100 text-lg max-w-2xl">
            All 6 New Zealand cat insurance providers compared side by side — price, cover, claims speed and key features.
          </p>
        </div>
      </section>

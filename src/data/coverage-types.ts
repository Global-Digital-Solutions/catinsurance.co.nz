...
export const coverageTypes: CoverageType[] = [
  {
    ...
    longFormSections: [
      ...
      {
        heading: 'How Much Does Accident Only Cat Insurance Cost in NZ?',
  ...
  },
  {
    ...
    longFormSections: [
      ...
      {
        heading: 'Comparing NZ Accident & Illness Plans: What to Look For',
  ...
  },
  {
    ...
    longFormSections: [
      {
        heading: 'Why Dental Cover Matters for Cats in NZ',
      ...
      {
        heading: 'Which Providers Offer Cat Dental Cover in NZ?',
  ...
  },
  {
    ...
    longFormSections: [
      ...
      {
        heading: 'Which Insurers Accept Older Cats in NZ?',
